...
class ClassActionPanel extends ConsumerWidget {
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: isProcessing
            ...
            : Text(
                gymClass.isPast
                    ? l10n.classesFinished
                    : gymClass.isFull
                    ? l10n.classesFull
                    : l10n.classesBookLong,
                style: const TextStyle(
                  fontSize: 18,
  ...
  Widget _buildTrainerActionButtons(
    BuildContext context,
    WidgetRef ref,
    bool isProcessing,
  ) {
      ...
      children: [
        Expanded(
          child: OutlinedButton(
            onPressed: (isProcessing || isStarted)
                ? null
        ...
        Expanded(
          ...
          child: ElevatedButton(
            onPressed: (isProcessing || isStarted)
                ? null
                : () => _showCancelClassDialog(context, ref),
            style: ElevatedButton.styleFrom(
  ...
  void _confirmCancel(BuildContext context, WidgetRef ref) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          l10n.classesCancelDialogBody(gymClass.name),
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text(
              l10n.classesCancelBookingShort,
              style: const TextStyle(
                color: AppColors.error,
                fontWeight: FontWeight.bold,
              ),
...
class _RescheduleModalState extends ConsumerState<_RescheduleModal> {
  ...
  Future<void> _submit() async {
    ...
    if (newTime.isBefore(DateTime.now())) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(l10n.classesReschedulePastError),
          backgroundColor: AppColors.error,
        ),
      );
      return;
    ...
    try {
      await ref
          .read(bookingNotifierProvider.notifier)
          .rescheduleClass(widget.gymClass.id, newTime);
