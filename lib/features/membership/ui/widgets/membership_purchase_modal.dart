...
class MembershipPurchaseModal extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final plans = [
      {
        'type': 'OPEN',
        'title': l10n.membershipPlanOpenTitle,
        'price': '170 zł',
        'desc': l10n.membershipPlanOpenDescription,
        'highlight': true,
      },
      {
        'type': 'NIGHT',
        'title': l10n.membershipPlanNightTitle,
        'price': '80 zł',
        'desc': l10n.membershipPlanNightDescription,
      },
      {
        'type': 'STUDENT',
        'title': l10n.membershipPlanStudentTitle,
        'price': '100 zł',
        'desc': l10n.membershipPlanStudentDescription,
      },
    ];
                                  ...
                                  children: [
                                    ...
                                    if (isHighlighted) ...[
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          l10n.membershipPurchasePopular,
                                          style: const TextStyle(
                                            color: Colors.white,
                                            fontSize: 10,
                                            fontWeight: FontWeight.bold,
                ...
                onPressed: purchaseState.isLoading
                    ...
                    : () async {
                        final success = await ref
                            .read(purchaseMembershipProvider.notifier)
                        ...
                        if (success) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                ref
                                    .read(purchaseMembershipProvider)
                                    .error
                                    .toString(),
                              ),
