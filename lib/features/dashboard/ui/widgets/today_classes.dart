...
class TodayClassesCarousel extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final hasActiveMembership =
        membershipAsync.valueOrNull?.active == true &&
    ...
    return todayClassesAsync.when(
      ...
      error: (err, stack) => Padding(
        ...
        child: Text(
          l10n.dashboardTodayClassesError,
  ...
  Widget _buildSkeleton() {
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) =>
            const AppSkeleton(width: 260, height: 180, borderRadius: 24),
      ),
    );
  }
}
  ...
  Widget _buildActionArea(
    ...
    if (gymClass.userEnrolled) {
      return Container(
        ...
        child: Text(
          AppLocalizations.of(context)!.classesBooked,
          style: const TextStyle(
            color: AppColors.primary,
            fontSize: 10,
            fontWeight: FontWeight.bold,
    ...
    return GestureDetector(
          ...
          : () async {
              try {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      AppLocalizations.of(context)!.classesGenericError(e),
                    ),
      ...
      child: Container(
        ...
        child: isProcessing
            ...
            : Text(
                AppLocalizations.of(context)!.classesBook,
                style: const TextStyle(
                  color: Colors.white,
                  fontWeight: FontWeight.bold,
                  fontSize: 12,
